...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-09-2025 a las 17:00:52
...
ALTER TABLE `registros`
  ...
  ADD CONSTRAINT `registros_ibfk_2` FOREIGN KEY (`vehiculo_id`) REFERENCES `vehiculos` (`id`),
  ADD CONSTRAINT `registros_ibfk_3` FOREIGN KEY (`espacio_id`) REFERENCES `espacios` (`id`),
  ADD CONSTRAINT `registros_ibfk_4` FOREIGN KEY (`tarifa_id`) REFERENCES `tarifas` (`id`),
  ADD CONSTRAINT `registros_ibfk_5` FOREIGN KEY (`convenio_id`) REFERENCES `convenios` (`id`);
